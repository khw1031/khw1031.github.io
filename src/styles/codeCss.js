...
export default css`
  :root {
    --code-font-family: "Fira Mono", Menlo, "Roboto Mono", Courier New,
      monospace;
  ...
  pre[class*="language-"] {
    ...
    margin-right: -1.5rem;
    overflow: auto;
    box-shadow: 0 0 1px rgba(0, 0, 0, 0.1), 0 0 1px rgba(0, 0, 0, 0.06),
      0 2px 2px rgba(0, 0, 0, 0.06), 0 4px 4px rgba(0, 0, 0, 0.06),
