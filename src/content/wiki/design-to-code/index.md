...
lintHash: '0d7eb2aba843'
polishHash: '0d7eb2aba843'
---
...
- [Design Principles](/wiki/design-principles/) — 인접 카테고리. 이쪽이 "디자인을 어떻게 코드로 옮기는가"(파이프라인)라면, 저쪽은 "무엇이 좋은 디자인인가"(사용성·미감의 규범). Google Stitch의 `DESIGN.md`가 두 카테고리의 접점.
