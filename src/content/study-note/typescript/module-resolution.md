---
title: "TypeScript moduleResolution의 node16·bundler·node10 차이와 배분 기준"
description: "moduleResolution은 'import 주소를 최종적으로 누가 해석하나'를 정하는 설정이다. node16과 bundler의 차이, 둘 다 exports를 존중한다는 공통점, node10만 위험한 이유, 패키지별 배분 근거를 정리한다."
---
