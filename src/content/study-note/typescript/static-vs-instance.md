---
title: "TypeScript static 메서드와 인스턴스 메서드의 선택 기준과 객체 모델"
description: "선택 기준은 그 동작이 객체별 상태·정체성(this)을 필요로 하는가 하나다. prototype 공유 관점의 객체 모델, static이 실제로 주는 이득 네 가지, '객체 생성 전 조립 API'의 의미, 인스턴스·static·module 함수 판단 순서, static과 singleton의 구분을 정리한다."
---
