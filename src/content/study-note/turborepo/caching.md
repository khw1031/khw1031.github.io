---
title: "Turborepo 로컬 캐싱과 캐시 키"
description: "task hash(inputs·global hash)로 캐시 hit/miss를 정하고 outputs를 .turbo/cache에 보관·복원하는 원리, outputs와 outDir의 구분, --cache 소스 제어."
---
