---
title: "Turborepo의 주요 기능 지도와 학습 순서"
description: "turbo run의 작업 그래프·병렬 실행, 로컬·원격 캐시, --filter의 변경 범위 실행, turbo prune의 배포 입력 축소, watch/--graph/--summarize 같은 진단 도구, 그리고 패키지 매니저와의 역할 분리."
---
