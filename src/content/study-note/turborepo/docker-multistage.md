---
title: "Turborepo Docker 멀티스테이지 빌드"
description: "turbo prune --docker 산출물을 base→pruner→builder→runner로 연결해 각 스테이지가 입력을 좁히는 이유, Docker 레이어 캐시의 json→install→full 순서, 최종 실행."
---
