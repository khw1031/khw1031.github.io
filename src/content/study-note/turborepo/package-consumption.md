---
title: "내부 package 소비 방식(Just-in-Time·Compiled)의 선택 기준과 task graph 영향"
description: "exports가 src를 가리키는 Just-in-Time과 dist를 가리키는 Compiled의 차이, 소비자가 TS를 컴파일할 수 있는지가 선택을 정하는 이유, typecheck·test의 ^build barrier 발생, exports 정보 은닉의 동등성, publishConfig가 발행 전용 치환인 이유."
---
