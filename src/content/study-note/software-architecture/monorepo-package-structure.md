---
title: "모노레포 package 배치의 확장 기준과 경계 강제 장치"
description: "flat + 이름 규약과 도메인·서비스별 중첩(packages/*/*)의 갈림길, 모듈러 모놀리스로 시작해 소유 경계가 생길 때 package로 승격하는 기준, FE·BE가 한 평면에 섞일 때의 그룹화, 그리고 폴더가 아니라 이름·exports·boundary 검사·AGENTS.md가 경계를 강제한다는 원칙."
---
