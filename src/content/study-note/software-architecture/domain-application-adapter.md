---
title: "Domain·Application·Port·Adapter의 책임 구분 기준과 관계 지도"
description: "도메인 규칙을 가려내는 네 가지 질문, Domain·Application·Port·Adapter의 역할 한 문장, Service라는 말의 다의성, Adapter와 BFF의 관계, 기능 명세와 도메인 규칙의 포함 관계."
---
