---
title: "NestJS Dynamic Module의 구성 시점과 설정 전달 규약 정리"
description: "정적 Module과 Dynamic Module의 차이, register()가 반환하는 DynamicModule 설계도, static이 singleton과 무관한 이유, 설정을 매개변수로 받고 Object.freeze로 고정하는 근거."
---
