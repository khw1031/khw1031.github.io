---
title: "NestJS Exception Filter의 오류-HTTP 번역 위치 선택 기준"
description: "도메인·조립 오류를 HTTP 상태로 바꾸는 분기를 컨트롤러에 둘 때와 Exception Filter로 옮길 때의 판단 기준, 필터 적용 범위, 대안(toHttpException·Result·오류 클래스 상속)의 트레이드오프."
---
