---
title: "NestJS DI 컨테이너와 Provider의 조립 원리·도메인 경계 정리"
description: "객체 생성을 대신 맡는 DI 컨테이너의 동작(design:paramtypes 리플렉션), Provider와 Service·Port·Adapter의 관계, 그리고 순수 도메인이 컨테이너에 등록되지 않는 이유."
---
