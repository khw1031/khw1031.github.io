...
pubDate: '2025-03-30'
description: "한샘몰 모바일 웹의 LCP·TBT를 렌더링 차단 제거와 디자인 시스템 번들 최적화로 개선하고 PSI API 기반 성능 모니터링을 자동화한 프로젝트 기록"
summary: "한샘몰 모바일 웹의 LCP·TBT·CLS를 개선한 과정 — 렌더링 차단 제거, 디자인 시스템 번들 최적화(ESM 분리·code splitting), PSI API 기반 모니터링 자동화로 LCP 6초→1.6초, TBT 1,200ms→380ms를 달성했다."
lang: ko
tags: ['performance', 'core-web-vitals', 'frontend', 'optimization']
lintHash: '0cf7f503a38a'
---
