---
title: 사내몰 웹 서비스 성능 최적화 프로젝트
pubDate: '2025-03-30T14:08:02+09:00'
noteId: FE-2503-001
description: "사내몰 모바일 웹의 LCP·TBT를 렌더링 차단 제거와 디자인 시스템 번들 최적화로 개선하고 PSI API 기반 성능 모니터링을 자동화한 프로젝트 기록"
summary: "사내몰 모바일 웹의 LCP·TBT·CLS를 개선한 과정 — 렌더링 차단 제거, 디자인 시스템 번들 최적화(ESM 분리·code splitting), PSI API 기반 모니터링 자동화로 LCP 6초→1.6초, TBT 1,200ms→380ms를 달성했다."
lang: ko
tags: ['performance', 'core-web-vitals', 'frontend', 'optimization']
lintHash: 'e15b6f182d49'
---

# 프로젝트 개요

사내몰 모바일 웹 서비스의 성능 개선을 위한 프로젝트를 진행했습니다. 주요 목표는 Google의 Core Web Vitals 지표인 **LCP (Largest Contentful Paint)**, **TBT (Total Blocking Time)**, **CLS (Cumulative Layout Shift)** 중심으로 성능을 개선하는 것이었습니다.
