...
pubDate: '2025-11-29T14:08:02+09:00'
noteId: LEARN-2511-001
description: "AI 사용은 탐지 불가능하므로 평가를 교실로 옮기고 AI 없이도 문제를 푸는 기초 근력과 검증 역량을 길러야 한다는 Karpathy의 교육 관점 정리"
summary: "AI 사용은 탐지 불가능하므로 평가를 교실로 옮기고, AI 없이도 문제를 풀 수 있는 기초 근력과 답을 검증하는 능력을 길러야 한다는 관점 — 숙제의 종말, 검증자로서의 인간, 평가 환경의 스펙트럼화."
lang: ko
tags: ['ai', 'education', 'assessment']
lintHash: 'bbb96efb7a1c'
---
