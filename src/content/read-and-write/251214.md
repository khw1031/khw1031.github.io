...
pubDate: '2025-12-14T14:08:02+09:00'
description: "추론을 자기완결적이고 검증 가능한 원자 단위로 분해해 CoT의 오류 연쇄 전파를 막는 Atom of Thought의 핵심 개념과 적용 조건 정리"
summary: "각 하위 질문을 자기완결적이고 의존성이 명시된 원자로 분해(DAG)하고 마르코프 속성(무기억성)으로 이력을 수축시켜 오류 누적과 컨텍스트 비용을 줄이는 AoT — 수학 증명·코드 디버깅·다중 홉 추론처럼 검증 가능한 문제에 효과적."
lang: ko
tags: ['llm', 'reasoning', 'prompting']
lintHash: 'ca9d9a243156'
---
...
>
>
> — <https://x.com/aiwithjainam/status/1999815060965994896>
