...
tags:
  ...
  - 'onboarding'
  - 'personal-ai'
lintHash: '9211872144d3'
polishHash: '9211872144d3'
---

## 아이디어

==사용자가 가진 기존 채팅 기록, 편지, 일기 등의 텍스트를 입력하면, 그 데이터에 담긴 특정 인물의 말투·성격·히스토리를 반영한 페르소나 챗봇을 생성하는 서비스.== 미리 준비된 기본 페르소나 템플릿 선택으로도 시작할 수 있어 진입 장벽을 낮춘다.
