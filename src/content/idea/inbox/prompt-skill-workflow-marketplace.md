...
summary: '프롬프트·스킬·워크플로 같은 실행형 AI 자산을 사고파는 중개 마켓 아이디어. 카테고리별 선점자(PromptBase·n8n·Smithery)가 이미 있어, 통합각·큐레이션·정산과 실행형 자산의 작동 검증에서 차별점을 찾아야 한다는 인박스 캡처.'
lang: ko
tags: [idea-inbox, marketplace, ai-agents, prompts, saas]
lintHash: 'a2c169b31872'
polishHash: 'a2c169b31872'
---
