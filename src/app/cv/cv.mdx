<Layout>
  ...
  <Section title="사이드 프로젝트">
    ...
    <Detail
      ...
      period="Claude Code 프롬프트 자산 라이브러리"
      role="Open Source"
      content={[
        {
          description: [
            "Claude Code 및 LLM 기반 도구를 위한 재사용 가능한 프롬프트 자산(Skills, Rules, Agents) 모음",
            "Progressive Disclosure 원칙 기반 3단계 로드 모델로 컨텍스트 효율성 극대화",
            "feature-workflow, qa-workflow, plan-workflow 등 실무 검증된 워크플로우 스킬 제공",
            "task-master, code-reviewer 등 서브에이전트 템플릿 제공",
          ]
        }
      ]}
    />
    ...
    <div className="avoid-break">
      <Keywords
        keywords={[
          ...
          { name: "Claude", color: "bg-neutral-700" },
