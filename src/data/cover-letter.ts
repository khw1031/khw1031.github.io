...
const data: DocumentPage = documentPageSchema.parse({
  title: '김현우 · Cover Letter',
  description: 'AI 도구 활용 워크플로우와 웹 성능 엔지니어링을 중심으로 한 자기소개.',
  sections: [
    {
      title: '소개',
      details: [
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              title: '슈퍼메이커즈',
              kind: 'prose',
              description: ['커머스 풀스택 플랫폼을 설계하고 리드했습니다.'],
            },
          ],
        },
        {
          ...
          content: [
            {
              title: '정량적 성능 개선',
              kind: 'prose',
              description: ['사용자 경험과 직결되는 성능 지표를 정량적으로 개선합니다.'],
            },
            {
              title: '주요 성과',
              description: [
