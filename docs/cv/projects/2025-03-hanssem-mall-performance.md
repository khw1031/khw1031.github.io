...
role: '프론트엔드 성능 개선 리드'
status: needs-input
source: 'src/content/inbox/2025-03-30-hanssem-mall-performance.md'
post: 'src/content/inbox/2025-03-30-hanssem-mall-performance.md'
...
- [Inbox draft](../../../src/content/inbox/2025-03-30-hanssem-mall-performance.md)
