...
| [notes-polish](notes-polish/SKILL.md) | Highlight (`==마커==`) + structure alignment over agent-authored collections (notes/inbox/specs/wiki/idea). Body-mutating; independent of `/lint` (scoped by note-promoter or manual batch). |
